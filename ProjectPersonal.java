public class ProjectPersonal 
{
    ...
    public static class NewCustomer 
    {
         ...
         */
        public NewCustomer(String customerName, String customerTelNum, String customerEmail, String customerPhyAdd) 
        {
    ...
    public static class NewArchitect 
    {
         ...
         */
        public NewArchitect(String archName, String archTelNum, String archEmail, String archPhyAdd) 
        {
    ...
    public static class NewBuildContractor 
    {
         ...
         */
        public NewBuildContractor(String buildName, String buildTelNum, String buildEmail, String buildPhyAdd) 
        {
